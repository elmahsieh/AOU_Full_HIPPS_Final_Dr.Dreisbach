...
def main(concept_file,outcome_file,durations_file):    
    ...
    HIP_trimester_events, HIP_trimester_summary = utilities.label_trimester_events(final_episodes_w_length, visit_table)
    
    HIP_trimester_event_details = utilities.summarize_trimester_events_by_concept(HIP_trimester_events)
